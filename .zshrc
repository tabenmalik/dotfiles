...
plugins=(git colored-man-pages colorize common-aliases docker docker-compose emoji fancy-ctrl-z git-prompt history isodate perms pip python ssh themes timer)
